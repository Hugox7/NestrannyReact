                        ...
                        <Card.Body>
                            <Card.Text>
                                <div className="formation">
                                    <p>1 - Les Autorisations de Programme et les crédits de Paiement (AP/CP)</p>
                                    <Button style={{ 'height': '40px' }} variant="secondary">Fiche</Button>
                                </div> 
                                <div className="formation">
                                    <p>2 - Monter son budget de service</p>
                                    <Button style={{ 'height': '40px' }} variant="secondary">Fiche</Button>
                                </div>
                                <div className="formation">
                                    <p>3 - Le débat d'orientations budgétaires</p>
                                    <Button style={{ 'height': '40px' }} variant="secondary">Fiche</Button>
                                </div>
                                <div className="formation">
                                    <p>4 - Le budget d'un service scolaire et de la caisse des écoles</p>
                                    <Button style={{ 'height': '40px' }} variant="secondary">Fiche</Button>
                                </div>
                                <div className="formation">
                                    <p>5 - Le budget d'un service enfance et petite enfance</p>
                                    <Button style={{ 'height': '40px' }} variant="secondary">Fiche</Button>
                                </div>
                                <div className="formation">
                                    <p>6 - Le budget des services techniques</p>
                                    <Button style={{ 'height': '40px' }} variant="secondary">Fiche</Button>
                                </div>
                                <div className="formation">
                                    <p>7 - Elaborer le budget d'une commune de moins de 3500 habitants</p>
                                    <Button style={{ 'height': '40px' }} variant="secondary">Fiche</Button>
                                </div>   
                            </Card.Text>
                        </Card.Body>
